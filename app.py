...
import hashlib, os, json, httpagentparser, urllib.request
...
PUSHER_SECRET_KEY   = config("PUSHER_SECRET_KEY")
PUSHER_CLUSTER      = config("PUSHER_CLUSTER")

app = Flask(__name__)
app.secret_key = os.urandom(24)

pusher = Pusher(app_id=PUSHER_APP_ID, key=PUSHER_KEY, secret=PUSHER_SECRET_KEY, cluster=PUSHER_CLUSTER, ssl=True)
